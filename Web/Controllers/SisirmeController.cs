...
{
    [Route("sisirme")]
    public class sisirmeController : Controller
    {
        ...
        public sisirmeController(ILogger<InsanKaynaklariController> logger, IPersonelService personelService, IShiftService shiftService, IPersonelShiftService personelShiftService, IPersonelOvertimeService personelOvertimeService)
        {
            _logger = logger;
        ...
        public IActionResult Index()
        {
            ...
            var result = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNow, WeekOfDay.dayNow);
            if (result.Success)
            {
        ...
        {
            var res = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNow, WeekOfDay.dayNow);
            if (res.Success)
            {
        ...
        public IActionResult shift_add(DepartmentsPersonelShiftsVM p)
        {
            ...
            {
                return RedirectToAction("shift", "Sisirme");
            }
        ...
        {
            var result = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNext, WeekOfDay.dayNow);
            if (result.Success)
            {
                return View(result.Data);
            }
        ...
        public IActionResult nextweek_shift_add()
        {
            ...
            if (result.Success)
            {
                var thisWeek = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNow, WeekOfDay.dayNow).Data.ToList();
        ...
        public IActionResult nextweek_shift_add(DepartmentsPersonelNextShiftsVM p)
        {
            ...
            {
                return RedirectToAction("nextweek_shift", "Sisirme");
            }
        ...
        public IActionResult nextweek_shift_update(DepartmentsPersonelShiftsVM p)
        {
            if (p == null)
            {
                return RedirectToAction("nextweek", "Sisirme");
            }
            foreach (var item in p.DepartmentsPersonelDtoVM)
            {
                _personelShiftService.Update(item);
        ...
        public IActionResult overtime(string date)
        {
            ...
            var result = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNow, date);
            if (result.Success)
            {
        ...
        public IActionResult overtime_add(string overtimeadd_date_input)
        {
            ...
            var result = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNow, overtimeadd_date_input);
            if (result.Success)
            {
        ...
        public IActionResult overtime_add(OvertimeVM p, string overtimeadd_date)
        {
            ...
            {
                return RedirectToAction("overtime", "Sisirme");
            }
        ...
        public IActionResult overtime_update(string overtimeupdate_date_input)
        {
            ...
            var result = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNow, overtimeupdate_date_input);
            if (result.Success)
            {
                OvertimeVM o = new OvertimeVM();
        ...
        public IActionResult overtime_delete(string overtimedelete_date_input)
        {
            ...
            var result = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.Sisirme, WeekOfDay.WeekNow, overtimedelete_date_input);
            if (result.Success)
            {
                OvertimeVM o = new OvertimeVM();
