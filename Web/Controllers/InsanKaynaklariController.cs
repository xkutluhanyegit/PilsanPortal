...
namespace Web.Controllers
{
    ...
    public class InsanKaynaklariController : Controller
    {
        ...
        public InsanKaynaklariController(ILogger<InsanKaynaklariController> logger, IPersonelService personelService, IShiftService shiftService, IPersonelShiftService personelShiftService, IPersonelOvertimeService personelOvertimeService)
        {
            _logger = logger;
        ...
        {
            var res = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.InsanKaynaklari, WeekOfDay.WeekNow, WeekOfDay.dayNow);
            if (res.Success)
            {
        ...
        public IActionResult shift_add(DepartmentsPersonelShiftsVM p)
        {
            ...
            {
                return RedirectToAction("shift", "insankaynaklari");
            }
        ...
        public IActionResult nextweek_shift_add()
        {
            ...
            if (result.Success)
            {
                var thisWeek = _personelService.GetAllDepartmentsPersonelDto(DepartmentsCode.InsanKaynaklari, WeekOfDay.WeekNow, WeekOfDay.dayNow).Data.ToList();
